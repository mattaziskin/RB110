...
We're recursively calling the method so before the loop refires, we're going
another depth into another method call.  we need to remove the call of
guess_number from within guess_number.  We alos need to call a break after
successfully guessing.
